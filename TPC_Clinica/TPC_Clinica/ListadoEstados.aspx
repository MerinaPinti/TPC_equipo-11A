<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ListadoEstados.aspx.cs" Inherits="TPC_Clinica.ListadoEstados" %>
    ...
    <div class="especialidad-list">
        ...
        <div class="row">
            <div class="col">
                ...
                <asp:GridView ID="dgvEspecialidades" DataKeyNames="Id" OnRowCommand="dgvEspecialidades_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="table mt-2">
                    <columns>
