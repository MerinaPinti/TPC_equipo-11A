<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ModificarPaciente.aspx.cs" Inherits="TPC_Clinica.ModificarPaciente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card-mod">
        ...
        <asp:Button 
            ID="btnGuardarCambios" runat="server" Text="Guardar cambios" CssClass="btn btn-mod w-100" OnClick="btnGuardarPaciente_Click" />
    </div>
</asp:Content>
